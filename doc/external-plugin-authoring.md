...
| Add Account settings, Dashboard, or CMS      | `@rizom/brain/services`   | [`operator-surface`](https://github.com/rizom-ai/brains/blob/main/packages/brain-cli/test/fixtures/public-authoring/operator-surface/src/index.ts)          |
